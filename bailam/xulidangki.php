<?php
   ...
   if ($password != $password2 )
    ...
    if (mysqli_num_rows(mysqli_query($conn, "SELECT tendangnhap FROM userlogin WHERE tendangnhap='$username'")) > 0){
    ...
    if (mysqli_num_rows(mysqli_query($conn, "SELECT email FROM userlogin WHERE email='$email'")) > 0)
    {
