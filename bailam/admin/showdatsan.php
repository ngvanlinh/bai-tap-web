                        ...
                        <tbody>
                            ...
                            while ($ds=mysqli_fetch_array($result,MYSQLI_ASSOC)) {
                                ...
                                <tr>
                                    ...
                                    <td> <a href="edit_ds.php?id=<?php echo $ds['id']; ?>"><img width="16" src="../image/icon_edit.png" htef="edit_kh.php"></a></td>
                                    <td> <a onclick="return confirm('Bạn có thực sự muốn xóa không!');" href="delete_ds.php?id=<?php echo $ds['id']; ?>"><img width="16" src="../image/icon_xoa.png" alt=""></a></td>
                                </tr> 
