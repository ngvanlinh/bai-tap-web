                    ...
                    <?php 
                            ...
                            if($_SERVER['REQUEST_METHOD']=='POST'){
                                ...
                                if(empty($errors)){
                                    if (($ngaydatsan=="select ngaydatsan from datsan") && ($giodatsan=="select giodatsan from datsan") && ($sosan=="select sosan from datsan")) {
                                        ...
                                        $results=mysqli_query($dbc,$query) or die("Quyery {$query} \n <br> Mysql errors:" .mysqli_error($dbc));
                                    }
                       ...
                       <form action="" name="add_datsan" method="POST">
                        <?php
                           ...
                           <input type="submit" name="submit" value="Đặt Sân" class="btn btn-primary" id="btndatsan" style="margin-left: -207px">
