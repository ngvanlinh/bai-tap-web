<?php
   ...
   if ($password != $password2 )
    ...
    if (mysqli_num_rows(mysqli_query($conn, "SELECT tendangnhap FROM dangnhap WHERE tendangnhap='$username'")) > 0){
    ...
    if (mysqli_num_rows(mysqli_query($conn, "SELECT email FROM dangnhap WHERE email='$email'")) > 0)
    {
